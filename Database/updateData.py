...
for i in stock_ticker[0:2]:
	print (i) #Company being added to database
	url = 'https://www.quandl.com/api/v3/datasets/WIKI/{0}/data.csv?start_date=2015-10-30?api_key=API_KEY_GOES_HERE'.format(i)
	...
	with open('test.csv', 'r') as f:
		...
		myList = list(reader)
		for row in myList:
			print (row) #Row of CSV file added to Database
